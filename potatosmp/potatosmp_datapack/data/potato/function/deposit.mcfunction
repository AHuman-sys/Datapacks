# --- Regular Potatoes ---
execute as @a[x=-96,y=71,z=-110,dx=0,dy=0,dz=0] if items block -96 68 -111 container.0 minecraft:potato[count=64] run scoreboard players add @s balance 63
...
# --- Baked Potatoes ---
execute as @a[x=-96,y=71,z=-110,dx=0,dy=0,dz=0] if items block -96 68 -111 container.0 minecraft:baked_potato[count=64] run scoreboard players add @s balance 126
...
execute as @a[x=-96,y=71,z=-110,dx=0,dy=0,dz=0] if items block -96 68 -111 container.0 minecraft:hay_block[custom_data={compressed_potato:true},count=64] run scoreboard players add @s balance 567
